...
require('./states/scanner/add-plant/add-plant-change.js')(context)
require('./states/scanner/add-plant/add-plant-save.js')(context)
require('./states/scanner/select-growth-phase/select-growth-phase.js')(context)
