...
var updateSchema = Joi.object(
	dropKeys(
		everythingOptionalExcept(joiObject, ['plant_growth_phase_change_id', 'version']),
...
module.exports = function plantGrowthPhaseChangeDb(connection) {
	...
	var saverOptions = { insertSchema: insertSchema, updateSchema: updateSchema, load: loadPlantGrowthPhase, db: connection }
