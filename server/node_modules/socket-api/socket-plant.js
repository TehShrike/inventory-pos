...
function saveDocument(addPlantDocument) {
	addPlantDocument.plantTags.map(tag => {
		return {
			tagNumber: tag,
			strainId: addPlantDocument.strain.stainId,
			roomId: addPlantDocument.room.roomId,
			growthPhase: addPlantDocument.growthPhase
		}
	})
}
